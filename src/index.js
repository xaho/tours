...
window.initMap = async function () {
    ...
    async function loadGpxToGmaps({files, albumUrl, date, type = '', color = '#FF0000'}) {
        ...
        for (let i = 0; i < files.length; i++) {
            ...
            elements.markers.push({element: marker, date: date, type});
        }
        return elements;
    }
    ...
    for (const event of [
        {date: new Date('2021-10-10'), title: 'JapFest', albumUrl: 'https://photos.app.goo.gl/Nf712gXEFfuAWzPi6', position: {lat: 52.9583015, lng: 6.5197671}},
        {date: new Date('2022-07-03'), title: 'Japan Classic Sunday', albumUrl: 'https://photos.app.goo.gl/hugWZThwUM18fShh9', position: {lat: 51.573976, lng: 5.659092}},
        {date: new Date('2023-07-02'), title: 'Japan Classic Sunday', albumUrl: 'https://photos.app.goo.gl/rnuKLQF1ddfF7ZQWA', position: {lat: 51.573976, lng: 5.661016}},
        {date: new Date('2023-09-30'), title: 'GoJapan', albumUrl: 'https://photos.app.goo.gl/EsMhXLd7uAsB8NGx5', position: {lat: 51.714717, lng: 4.883165}},
        {date: new Date('2024-05-18'), title: 'SPA Classic', albumUrl: 'https://photos.app.goo.gl/cuPdMh7APGJ3AnSa9', position: {lat: 50.442965, lng: 5.970453}},
        {date: new Date('2024-07-06'), title: 'CTD Summer Meet', albumUrl: 'https://photos.app.goo.gl/bSw33Cv9FAUcNwR3A', position: {lat: 51.638447, lng: 6.586215}},
        {date: new Date('2024-07-07'), title: 'Japan Classic Sunday', albumUrl: 'https://photos.app.goo.gl/mQm1eXdhwBV5zMYn6', position: {lat: 51.612371, lng: 4.901104}},
        {date: new Date('2025-03-01'), title: 'ALV', albumUrl: 'https://photos.app.goo.gl/b7FLGqfXh6EjhWsU9', position: {lat: 51.9416639, lng: 5.7633148}},
        {date: new Date('2025-05-23'), title: 'SPA Classic', albumUrl: 'https://photos.app.goo.gl/Y3aFsSKgHiUAJ4A7A', position: {lat: 50.442965, lng: 5.970453 + 0.002}},
        {date: new Date('2025-08-30'), title: 'Kofferbakverkoop', albumUrl: 'https://photos.app.goo.gl/haa2SzPKDhMsruEt5', position: {lat: 51.883364, lng: 5.531067}},
        {date: new Date('2025-09-07'), title: 'GoJapan', albumUrl: 'https://photos.app.goo.gl/7e1PAGrkiDsYjSgR8', position: {lat: 51.714717, lng: 4.883165 + 0.002}}
    ]) {
    ...
    function updateAmount(lower, upper) {
    ...
    $(slider).slider({
        ...
        slide: function (event, ui) {
            updateAmount(ui.values[0], ui.values[1]);
        }
    });
